...
private:
	...
	static int NumberOfCards;  // Number of CardTen objects used in resetting the values of cardprice and fees if all the cardten objects are deleted
...
public:
	...
	void ReadCardParameters(Grid* pGrid);		// Reads the parameters of CardTen which is: cardPrice and fees
