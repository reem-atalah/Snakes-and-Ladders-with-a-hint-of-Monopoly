...
private:
	...
	static int NumberOfCards;  // Number of CardTen objects used in resetting the values of cardprice and fees if all the cardtwelve objects are deleted
...
public:
	...
	void ReadCardParameters(Grid* pGrid);		// Reads the parameters of CardTwelve which is: cardPrice and fees
	void Apply(Grid* pGrid, Player* pPlayer);		// Applies the effect of CardTwelve on the passed Player
